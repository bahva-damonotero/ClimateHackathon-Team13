...
=== "Preview"
    ...
    <iframe src="https://pages.github.boozallencsn.com/uip/docs/examples-react/#/homepage-template" width="100%" frameBorder="0"></iframe>
...
=== "JSX"
    ...
    import imgCircle from 'uswds/src/img/circle-124.png';
