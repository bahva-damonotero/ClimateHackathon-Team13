  ...
  children: (
    <>
      <IconListItem>
        ...
        <IconListContent>
          <h3 className="usa-icon-list__title">Donate cash when possible.</h3>
          <p>
...
customSizeWithRichContent.args = {
  children: (
    <>
      <IconListItem>
        <IconListIcon
  ...
  children: (
    <>
      <IconListItem>
        ...
        <IconListContent>This item uses a Font Awesome icon.</IconListContent>
      </IconListItem>
